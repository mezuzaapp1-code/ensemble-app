...
from onboarding import (
    ...
    get_profile,
    get_profile_active_tool_set,
    get_uploaded_prompt_injection,
    normalize_active_tools_list,
    persist_session_upload,
    profile_for_client,
    profile_save_kwargs_from_request,
    save_profile,
)
import bcrypt
import jwt
...
def update_session_profile(session_id: str, req: ProfileRequest):
    ...
    save_profile(
        ...
        preferences=req.preferences,
        memory_context=req.memory_context,
        **profile_save_kwargs_from_request(req),
    )
